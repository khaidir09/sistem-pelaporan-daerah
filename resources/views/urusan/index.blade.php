        ...
        <div class="py-3 d-flex align-items-sm-center flex-sm-row flex-column">
            ...
            <div class="text-end">
                <ol class="breadcrumb m-0 py-0">
                     <a href="" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#standard-modal">Tambah Urusan</a>
                </ol>
            </div>
        </div>
        ...
        <div class="modal-content">
            ...
            <form action="{{ route('urusan.store') }}" method="post">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group mb-3 col-md-12">
                        <label for="input1" class="form-label">Kode Urusan</label>
                        <input type="text" class="form-control" name="kode_urusan"   id="input2"> 
                    </div>
                    <div class="form-group mb-3 col-md-12">
                        <label for="category" class="form-label">Kategori Urusan</label>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="category_id" id="category1" value="1" checked>
                            <label class="form-check-label" for="category1">
                                Urusan Pemerintahan Wajib Berkaitan Pelayanan Dasar
                            </label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="category_id" id="category2" value="2">
                            <label class="form-check-label" for="category2">
                                Urusan Pemerintahan Wajib Tidak Berkaitan Pelayanan Dasar
                            </label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="category_id" id="category3" value="3">
